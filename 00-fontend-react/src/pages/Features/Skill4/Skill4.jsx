        ...
        <main className="overflow-hidden bg-white">
            <div className="flex max-md:flex-col">
                <section className="ml-5 w-[90%] max-md:ml-0 max-md:w-full">
                    <div className="overflow-hidden grow w-full min-h-[900px] min-w-80 max-md:mt-9 max-md:max-w-full">
                        <div className="flex flex-col py-6 pr-20 pl-5 w-full bg-white max-md:pr-5 max-md:max-w-full">
                            <Skill4Header />

                            <div className="self-end px-10 pt-2 pb-6 mt-6 max-w-full w-[1077px] max-md:px-5">
