...
const CourseCard = ({ title, imageUrl }) => {
    return (
        <article className="flex flex-col px-16 py-4 w-full bg-white rounded-lg shadow-[0px_2px_10px_rgba(0,0,0,0.1)] max-md:px-5">
            ...
            <button className="self-center px-14 py-3.5 max-w-full text-sm font-bold leading-none text-center text-white whitespace-nowrap rounded bg-slate-500 w-[151px] max-md:px-5">
                LEARN
            </button>
        </article>
    );
