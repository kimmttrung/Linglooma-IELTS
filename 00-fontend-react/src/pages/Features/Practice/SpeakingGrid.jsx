...
const SpeakingGrid = ({ setCurrentQuestion, setCurrentIndex }) => {
    ...
    //             // Giả sử API thành công trả về dạng { questions: [...], message: "Success" }
    //             // Nếu không có questions hoặc không phải array thì lỗi
    ...
    //             // Nếu có message dạng lỗi (ví dụ server trả message là lỗi)
    //             // bạn có thể kiểm tra thêm, ví dụ:
