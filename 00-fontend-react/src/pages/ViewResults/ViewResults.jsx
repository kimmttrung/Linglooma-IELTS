...
const ViewResultsPage = () => {
    const results = [
        { id: 1, name: 'Bài 1 - Technology', date: 'dd/mm/yyyy', score: '0%' },
        { id: 2, name: 'Bài 2 - Environment', date: 'dd/mm/yyyy', score: '0%' },
        { id: 3, name: 'Bài 3 - Education', date: 'dd/mm/yyyy', score: '0%' },
        { id: 4, name: 'Bài 4 - Health', date: 'dd/mm/yyyy', score: '0%' },
    ];
